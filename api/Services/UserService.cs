...
namespace dp.api.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        public async Task<AccessToken> Authenticate(string email, string password, Role userType)
        {
            ...
            UserDb user = await AdoDao.UserDao.ValidateUser(email, password, userType);
            ...
            var jwtToken = _jwtUtils.GenerateJwtToken(new UserDb() { UserId= user.UserId, Role= user.Role});
